 ...
 * 
 * { abc: iTokPlugin::PARAM_LIST, xyz: iTokPlugin::REQUIRE_BODY | iTokPlugin::TEXT | iTokPlugin::REDO }
 *  
 * @param Tokenizer &$tok (Reference)
 * @return map<name:int>
 */
public static function getPlugins(&$tok);
