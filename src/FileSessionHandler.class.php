...
public function open($save_path, $session_name) {
	\rkphplib\lib\log_debug("FileSessionHandler.open:28> open($save_path, $session_name)");
	return true;
}
...
public function close() {
	\rkphplib\lib\log_debug("FileSessionHandler.close:47>");
	return true;
}
...
public function create_sid() {
  ...
  for ($i = 0; $i < 4; $i++) {
	...
	// \rkphplib\lib\log_debug("FileSessionHandler.create_sid:139> create_sid() = $id");
	$this->path .= '/'.$id.'.json';
  return $id;
}
