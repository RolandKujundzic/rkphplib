...
private function &getArray(string $name = '', string $type = '') : array {
	...
	// \rkphplib\lib\log_debug("TArray.&getArray:92> TArray.&getArray:92> TArray.&getArray:92> TArray.&getArray:92> TArray.&getArray:92> TArray.&getArray:92> TArray.&getArray:92> TArray.&getArray:92> TArray.&getArray:92> name=[$name] type=[$type] env.name=[".$this->env['name']."]");
